...
//-- Cuando transcurren 1000 ms se llama a la función tarea 1
setTimeout(tarea1, 1000);

/* Esta estructura también es muy típica:
incluir la función de retrollamada directamente en el parámetro,
en vez de definirla fuera */
setTimeout( () => {
...
Se guarda su identificador en la variable id para poder
quitar el temporiador con ClearInterval */
let id = setInterval( () => {
    console.log("Tic...");
}, 200);
